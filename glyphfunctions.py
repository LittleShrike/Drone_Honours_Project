# -*- coding: utf-8 -*-
"""
Created on Mon Oct  9 16:57:32 2017
...
def get_glyph_pattern(image, black_threshold, white_threshold):
    ...
    print "Row then col info"
    print "Row 1: {0}".format(row1)
    print "Row 2: {0}".format(row2)
    print "Row 3: {0}".format(row3)
    print "Col 1: {0}".format(col1)
    print "Col 2: {0}".format(col2)
    print "Col 3: {0}".format(col3)     
    cells.append(image[row1, col1])
    cells.append(image[row1, col2])
